...
public final class EndCrystalWM {
    ...
    private static final String EXPECTED_CONSTANT_FINGERPRINT =
            "175aa2f5babd42c0d58d0d1f82bcdfe6f29cc3d49e818391af2ddcc9ce9c7e09";
    ...
    private static final String[] BRAND_COLOR_NAMES = new String[]{"AQUA", "LIGHT_PURPLE", "BLUE", "DARK_AQUA"};
    private static final String[] UPGRADE_COLOR_NAMES = new String[]{"GOLD", "YELLOW", "GREEN", "LIGHT_PURPLE"};
    ...
    private static void styleRichLinkComponent(
        ...
        Object hoverEvent = createHoverEvent(baseComponentClass, textComponentClass, hoverText);
        if (hoverEvent != null) {
            invokeForSideEffects(
                    linkComponent,
                    "setHoverEvent",
    ...
    private static Object createHoverEvent(Class<?> baseComponentClass, Class<?> textComponentClass, String hoverText) {
